...
\#2. Creación de modelo predictivo Una vez están listos los datos, podemos crear un modelo predictivo que evalúa la importancia de las variables, como por ejemplo [<tt>rpart</tt>](https://cran.r-project.org/web/packages/rpart/).
