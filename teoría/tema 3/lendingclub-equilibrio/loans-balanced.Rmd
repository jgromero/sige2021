...
_Balanceo_ de clases con el dataset [Lending Club](https://www.lendingclub.com/info/download-data.action).
...
*Atención*: Esta validación está hecha con el conjunto obtenido después del "downsampling". Para hacer la comparación adecuadamente, hacemos una validación con un conjunto de datos de test completo.

```{r}
# Ajustar niveles (igual que en función extend_levels)
...
*Atención*: Esta validación está hecha con el conjunto obtenido después del "upsampling". Para hacer la comparación adecuadamente, haríamos una validación con un conjunto de datos de test completo.
